        ...
        <section className="py-24 bg-background overflow-hidden relative">
            <div className="container px-4 md:px-6">
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    >
                        <Card className="border-white/10 bg-card/80 backdrop-blur-xl overflow-hidden shadow-2xl rounded-2xl">
                            ...
                            <div className="flex flex-col md:flex-row h-[500px]">
                                ...
                                <div className="w-full md:w-64 border-r border-white/5 p-6 space-y-8 hidden md:block bg-black/20">
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Projeto Atual</label>
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Estilo Selecionado</label>
                                ...
                                <div className="flex-1 p-8 flex flex-col items-center justify-center relative">
                                    ...
                                    <div className="w-full max-w-md aspect-[4/3] rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center gap-6 bg-card/50 transition-colors hover:bg-muted/50 cursor-pointer group">
                                        ...
                                        <div className="text-center space-y-2">
                                            <h3 className="text-lg font-semibold text-foreground">Arraste suas fotos aqui</h3>
                                            <p className="text-sm text-muted-foreground">JPG ou PNG até 5MB</p>
                                        </div>
                                    </div>

                                    <div className="mt-10 flex gap-4 w-full max-w-md">
                                        <Button variant="ghost" className="text-muted-foreground hover:text-foreground flex-1">Limpar</Button>
